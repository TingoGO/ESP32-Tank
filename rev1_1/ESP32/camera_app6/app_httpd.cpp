...
extern enum Aspect_ratio aspect_ratio;
...
static esp_err_t cmd_handler(httpd_req_t *req) {
  ...
  if (!strcmp(variable, "framesize")) {
    ...
    res = s->set_ae_level(s, val);  //add here
  else if (!strcmp(variable, "zoom")) {
    // s->set_res_raw(s, 0, 0, 0, 0, 16 *  val, 12 * val, 1600 - 32 * val, 1200 - 24 * val, 1600 - 32 * val, 1200 - 24 * val, true, true);
    image_zoom(s, val, aspect_ratio);
    //s->set_res_raw(s, 0, 0, 0, 0, 16 * val, 12 * val, 1600 - 32 * val, 1200 - 24 * val, 1600 - 32 * val, 1200 - 24 * val, true, true);

  } else if (!strcmp(variable, "aspect_ratio"))
    aspect_ratio = (Aspect_ratio)val;
  else if (!strcmp(variable, "photosetting"))
    s->set_res_raw(s, 0, 0, 0, 0, 0, 0, 1600, 1200, 1600, 1200, true, true);
